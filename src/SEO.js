    ...
    <>
      ...
      <div className="prose-lg m-10">
        ...
        <div className="grid justify-items-center mt-12 mb-10 md:mb-10">
          <a
            href="https://secure.2checkout.com/checkout/buy?merchant=251713958172&tpl=default&prod=VRV2OCH91K&qty=1"
            target="_blank"
            rel="noreferrer"
          >
            <button className="py-2 px-8 shadow-md bg-living-red hover:opacity-80 text-white">
              Buy Now
            </button>
          </a>
        </div>
